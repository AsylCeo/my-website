...
$up = $_POST['up'] * 1000; 
$ping = $_POST['ping'];
$server = '7961';// Change Server code according to your location from here https://c.speedtest.net/speedtest-servers-static.php
$accuracy = 8;
$hash = md5("$ping-$up-$down-297aae72");
$headers = Array(
      'POST /api/api.php HTTP/1.1',
      'Host: www.speedtest.net',
      'User-Agent: asyl Speedtest',
...
<footer class="bg-white bg-gray-900 fixed inset-x-0 bottom-0">
    <div class="flex justify-center">
    <p class="p-4 text-yellow-300">Maintained with ❤️ by <a href="https://github.com/asylceo" class="hover:underline" target="_blank">asylceo</a></p>
    </div>
</footer>
</body>
